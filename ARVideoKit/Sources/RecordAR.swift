...
@objc public class RecordAR: ARView {
     ...
     */
    @objc public var fps: ARVideoFrameRate = .fps30
    /**
     ...
     */
    @objc public var contentMode: ARFrameMode = .aspectFit
    /**
    ...
    func setup() {
        if let view = view as? ARSCNView {
            ...
            var plane = SCNPlane(width: view.bounds.width, height: view.bounds.height)
            plane = SCNPlane(width: CGFloat(1440), height: CGFloat(1920))
